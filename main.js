...
console.log(`You will be accompanying ${drovers.size} drovers as they drive ${cattleToDrive} cattle to Old Red's Ranch for grazing`)
console.log(`\nThe herd is made of up the following cattle (only their breed is shown):`)
for (const cattles of cattle) {
console.log(`${cattles.breed}\n`)
}
